                ...
                <div className="hidden bg-[rgba(0,0,0,0.7)] group-hover:flex absolute top-0 left-0 w-[100%]  h-[100%] justify-center items-center">
                  <div className="z-[1]">
                    <div className="flex flex-col ">
                      <a className="bg-[#e28007] text-[#fff] font-bold px-8 py-3 rounded-[30px] hover:bg-transparent hover:border hover:border-2  border-[#e28007] cursor-pointer hover:ease-in">
                        Live View
                      </a>
                      <a className="bg-[#e28007] font-bold text-[#fff] px-8 py-3 mt-5 rounded-[30px] hover:bg-transparent hover:border hover:border-2   border-[#e28007]  cursor-pointer hover:ease-in">
                        Git Hub
                      </a>
                    </div>
                  </div>
